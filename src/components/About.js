    ...
    <>
      ...
      <div className="about">
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-6 abtcards">
              <img className="abticon" src={grp} alt="" />
              <br />
              <h3>Social distancing from other groups</h3>
              <br />
              <h4>
            ...
            <div className="col-6">
              <img className="abticon" src={sanitize} alt="" />
              <br />
              <h3>Sanitising after each and every guest</h3>
              <br />
              <h4>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-6 abtcards">
              <img className="abticon" src={socialdistancing} alt="" />
              <br />
              <h3>Social distancing from other groups</h3>
              <br />
              <h4>
            ...
            <div className="col-6">
              <img className="abticon" src={safety} alt="" />
              <br />
              <h3>Sanitising after each and every guest</h3>
              <br />
              <h4>
